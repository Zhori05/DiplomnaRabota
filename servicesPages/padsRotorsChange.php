...
<head>
    ...
    <title>Смяна на накладки и дискове</title>
    <link rel="stylesheet" href="../styles/navbar-style.css">
    <link rel="stylesheet" href="../styles/responsive.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" integrity="sha512-..." crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="../styles/servicePage.css">
    <style>.hero .hero-image{
    background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("../images/1550239874-oem-bmw-1470693242-services-brake.jpg");
    }
    </style>
...
<nav>
    <div class="wrapper">
      ...
      <div class = "hero">
        ...
        <div class = "hero-text">
        <h1>Смяна на накладки и дискове</h1>
      </div>
      </div>
    </div>
    ...
    <main>
      <div class = "infoLine">
        <h3>Смяна на накладки и дискове</h3>
      </div>
      ...
      <div class = "infoContainer">
        <div class = "information">
          ...
          <p>Смяната на дискове и накладки е от съществено значение за поддръжката на автомобила и осигуряването на безопасност по пътищата. Важността й се проявява в няколко аспекта: Сигурност-Дисковете и накладките са от основно значение за спирането на автомобила. Износването на тези части може да намали ефективността на спиране и да увеличи спирачното разстояние, което може да доведе до инциденти. Ефективност на спирачната система - Новите дискове и накладки осигуряват по-добро спиране и по-голяма контролируемост на автомобила, което може да повиши общата безопасност на шофиране.</p>
        </div>
        </div>
