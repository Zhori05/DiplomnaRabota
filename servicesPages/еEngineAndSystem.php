...
<head>
    ...
    <title>Сервизиране на ел. двигател и системи за управление</title>
    <link rel="stylesheet" href="../styles/navbar-style.css">
    <link rel="stylesheet" href="../styles/responsive.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" integrity="sha512-..." crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="../styles/servicePage.css">
    <style>.hero .hero-image{
    background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("../images/march-2020-baden-wuerttemberg-stuttgart-a-car-mechanic-news-photo-1665409887.jpg");
    }
    </style>
...
<nav>
    <div class="wrapper">
      ...
      <div class = "hero">
        ...
        <div class = "hero-text">
        <h1>Сервизиране на ел. двигател и системи за управление</h1>
      </div>
      </div>
    </div>
    ...
    <div class = "aboutICars">
      ...
      <div class = "infoLine">
        <h3>Сервизиране на ел. двигател и системи за управление</h3>
      </div>
      ...
      <div class = "infoContainer">
        <div class = "information">
          <h1>M car Service</h1>
          <div class = "pContainer">
          <p>Сервизирането на ел. двигател и системи за управление включва диагностика и поддръжка на електрическите двигатели, инверторите, контролерите и други електронни системи.Също така се извършват софтуерни актуализации и предоставят обучение за собствениците за оптималната употреба и поддръжка на системите за управление на двигателя.</p>
        </div>
        </div>
