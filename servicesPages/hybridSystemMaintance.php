...
<head>
    ...
    <title>Проверка на хибридната система</title>
    <link rel="stylesheet" href="../styles/navbar-style.css">
    <link rel="stylesheet" href="../styles/responsive.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" integrity="sha512-..." crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="../styles/servicePage.css">
    <style>.hero .hero-image{
    background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("../images/63c988e5b497fd5191cf2099_WF51216_LITGRE_SeptemberContent_MaintainingaPlug-InHybrid_Header.webp");
    }
    </style>
...
<nav>
    <div class="wrapper">
      ...
      <div class = "hero">
        ...
        <div class = "hero-text">
        <h1>Проверка на хибридната система</h1>
      </div>
      </div>
    </div>
    ...
    <div class = "aboutICars">
      ...
      <div class = "infoLine">
        <h3>Проверка на хибридната система</h3>
      </div>
      ...
      <div class = "infoContainer">
        <div class = "information">
          <h1>M car Service</h1>
          <div class = "pContainer">
          <p>Проверката на хибридната система включва диагностика на всички компоненти на системата, проверка на ефективността й, преглед на системите за регенеративно спиране и превключване между режимите на работа. Също така се проверяват системите за охлаждане и отопление. Тази услуга е важна за гарантиране на безпроблемната работа и ефективност на хибридния автомобил.</p>
        </div>
        </div>
