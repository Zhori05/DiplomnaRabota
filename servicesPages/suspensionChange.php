...
<head>
    ...
    <title>Смяна на консумативи по окачването</title>
    <link rel="stylesheet" href="../styles/navbar-style.css">
    <link rel="stylesheet" href="../styles/responsive.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" integrity="sha512-..." crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="../styles/servicePage.css">
    <style>.hero .hero-image{
    background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("../images/bmw-value-service.jpg");
    }
    </style>
...
<nav>
    <div class="wrapper">
      ...
      <ul class="nav-links">
        ...
        <li><a href="/mysite/DiplomnaRabota/contact-us.html">За нас</a></li>
      ...
      <div class = "hero">
        ...
        <div class = "hero-text">
        <h1>Смяна на консумативи по окачването</h1>
      </div>
      </div>
    </div>
    ...
    <main>
      <div class = "infoLine">
        <h3>Смяна на консумативи по окачването</h3>
      </div>
      ...
      <div class = "infoContainer">
        <div class = "information">
          ...
          <p>Смяната на консумативите на окачването на колата е критична за поддържането на безопасността, комфорта и ефективността на превозното средство. Повредените или износени консумативи могат да доведат до намалена сигурност по време на шофиране, като увеличават риска от загуба на контрол или неочаквани реакции на автомобила. Освен това, с износеното окачване може да се увеличи усещането за вибрации и шумове по време на пътуване, което намалява комфорта на водача и пътниците. Подмяната на консумативите също може да помогне за удължаване на живота на други компоненти на автомобила и да предотврати по-големи разходи за ремонт. Правилното функциониране на окачването осигурява по-добро управление и маневреност на автомобила, като в крайна сметка увеличава сигурността и комфорта на шофиране.</p>
        </div>
        </div>
