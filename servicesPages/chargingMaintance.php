...
<head>
    ...
    <title>Обслужване на системи за зареждане</title>
    <link rel="stylesheet" href="../styles/navbar-style.css">
    <link rel="stylesheet" href="../styles/responsive.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" integrity="sha512-..." crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="../styles/servicePage.css">
    <style>.hero .hero-image{
    background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("../images/P90403805-bmw-ix3-flexible-fast-charger-10-2020-2121px.jpg");
    }
    </style>
...
<nav>
    <div class="wrapper">
      ...
      <div class = "hero">
        ...
        <div class = "hero-text">
        <h1>Обслужване на системи за зареждане</h1>
      </div>
      </div>
    </div>
    ...
    <div class = "aboutICars">
      ...
      <div class = "infoLine">
        <h3>Обслужване на системи за зареждане</h3>
      </div>
      ...
      <div class = "infoContainer">
        <div class = "information">
          <h1>M car Service</h1>
          <div class = "pContainer">
          <p>Обслужването на системи за зареждане на електрически и хибридни автомобили включва проверка на зарядните устройства, кабелите и конекторите за зареждане, ремонт и предоставяне на консултации и обучение за собствениците.  В случай на повреда или неизправност на зарядна станция, ние извършваме ремонт и поддръжка за възстановяване на нейната функционалност. Това може да включва замяна на компоненти, ремонт на електроника или други процедури. Тези услуги са от съществено значение за гарантирането на ефективното и безпроблемно зареждане на автомобилите с електрическо задвижване.</p>
        </div>
        </div>
