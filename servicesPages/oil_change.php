...
<head>
    ...
    <title>Смяна на масла и филтри</title>
    <link rel="stylesheet" href="../styles/navbar-style.css">
    <link rel="stylesheet" href="../styles/responsive.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" integrity="sha512-..." crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="../styles/servicePage.css">
    <style>.hero .hero-image{
    background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("../images/bmw_aftersales_design_services_value-service-2x.webp");
    }
    </style>
</head>
<body>
    ...
    <main>
      ...
      <div class = "infoContainer">
        <div class = "information">
          ...
          <p>Смяната на моторното масло и филтрите е от съществено значение за поддържането на здравословното състояние на автомобила. Процедурата включва източване на старото масло, замяна на маслен и въздушен филтър, както и при необходимост - филтри за горивото и климатична система. Тази редовна грижа не само удължава живота на двигателя, но и подобрява неговата ефективност и икономичност. Правилната смяна на масло и филтри осигурява оптимална работа на автомобила и намалява риска от сериозни повреди и неизправности.</p>
        </div>
        </div>
